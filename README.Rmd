...
R switched to using HTML5 in R 4.2.0, and CRAN has started enforcing that packages on CRAN generate valid HTML5. In a few cases, roxygen2 was generating invalid HTML5, so many packages have been notified that they have issues. **We expect that simply updating roxygen2 to its latest CRAN version (7.2.1), redocumenting, and then sending your package back in is enough to fix 99.9% of the issues you might see.**
